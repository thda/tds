...
func TestConverters(t *testing.T) {
	...
	testValues := []testValue{
		// int
		{value: int64(3230), err: nil, columnDesc: "int not null", output: int64(3230)},
		{value: math.MaxInt32 + 1, err: ErrOverFlow, columnDesc: "int not null", output: nil},
		{value: math.MinInt32 - 1, err: ErrOverFlow, columnDesc: "int not null", output: nil},
		{value: int64(math.MaxInt32), err: nil, columnDesc: "int not null", output: int64(math.MaxInt32)},
		{value: int64(math.MinInt32), err: nil, columnDesc: "int not null", output: int64(math.MinInt32)},
		{value: nil, err: nil, columnDesc: "int null", output: nil},
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "int not null", output: nil},

		// smallint
		{value: int64(3230), err: nil, columnDesc: "smallint not null", output: int64(3230)},
		{value: math.MaxInt16 + 1, err: ErrOverFlow, columnDesc: "smallint null", output: nil},
		{value: math.MinInt16 - 1, err: ErrOverFlow, columnDesc: "smallint null", output: nil},
		{value: int64(math.MaxInt16), err: nil, columnDesc: "smallint not null", output: int64(math.MaxInt16)},
		{value: int64(math.MinInt16), err: nil, columnDesc: "smallint not null", output: int64(math.MinInt16)},
		{value: nil, err: nil, columnDesc: "smallint null", output: nil},
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "smallint not null", output: nil},

		// date
		{value: time.Date(1900, time.Month(1), 1, 0, 0, 0, 0, time.Local), err: nil, columnDesc: "date not null", output: time.Date(1900, time.Month(1), 1, 0, 0, 0, 0, time.Local)},
		{value: time.Date(0000, time.Month(12), 31, 0, 0, 0, 0, time.Local), err: ErrOverFlow, columnDesc: "date not null", output: nil},
		{value: time.Date(10000, time.Month(1), 1, 0, 0, 0, 0, time.Local), err: ErrOverFlow, columnDesc: "date not null", output: nil},
		{value: nil, err: nil, columnDesc: "date null", output: nil},
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "date not null", output: nil},

		// bit
		{value: false, err: nil, columnDesc: "bit", output: false},
		{value: true, err: nil, columnDesc: "bit", output: true},
		{value: nil, err: ErrNonNullable, columnDesc: "bit", output: false},

		// binary
		{value: nil, err: nil, columnDesc: "binary(1) null", output: nil},
		{value: []byte{00, 01}, err: nil, columnDesc: "binary(1) null", output: []byte{00}},
		{value: "nil", err: ErrBadType, columnDesc: "binary(1) null", output: nil},
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "binary(1) not null", output: nil},

		// varbinary
		{value: []byte{00, 01}, err: nil, columnDesc: "varbinary(2) null", output: []byte{00, 01}},
		{value: nil, err: nil, columnDesc: "varbinary(2) null", output: nil},
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "varbinary(2) not null", output: nil},

		// datetime
		{value: time.Date(1900, time.Month(1), 1, 0, 0, 0, 0, time.Local), err: nil, columnDesc: "datetime not null", output: time.Date(1900, time.Month(1), 1, 0, 0, 0, 0, time.Local)},
		{value: time.Date(1752, time.Month(12), 31, 0, 0, 0, 0, time.Local), err: ErrOverFlow, columnDesc: "datetime not null", output: nil},
		{value: time.Date(10000, time.Month(1), 1, 0, 0, 0, 0, time.Local), err: ErrOverFlow, columnDesc: "datetime not null", output: nil},
		{value: nil, err: nil, columnDesc: "datetime null", output: nil},
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "datetime not null", output: nil},

		// smalldatetime
		{value: time.Date(1900, time.Month(1), 1, 0, 0, 0, 0, time.Local), err: nil, columnDesc: "smalldatetime not null", output: time.Date(1900, time.Month(1), 1, 0, 0, 0, 0, time.Local)},
		{value: time.Date(1899, time.Month(12), 31, 0, 0, 0, 0, time.Local), err: ErrOverFlow, columnDesc: "smalldatetime not null", output: nil},
		{value: time.Date(2080, time.Month(1), 1, 0, 0, 0, 0, time.Local), err: ErrOverFlow, columnDesc: "smalldatetime not null", output: nil},
		{value: nil, err: nil, columnDesc: "smalldatetime null", output: nil},
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "smalldatetime not null", output: nil},

		// bigdatetime
		{value: time.Date(1900, time.Month(1), 1, 0, 0, 0, 999999000, time.Local), err: nil, columnDesc: "bigdatetime not null", output: time.Date(1900, time.Month(1), 1, 0, 0, 0, 999999000, time.Local)},
		{value: time.Date(0000, time.Month(12), 31, 0, 0, 0, 0, time.Local), err: ErrOverFlow, columnDesc: "bigdatetime not null", output: nil},
		{value: time.Date(10000, time.Month(1), 1, 0, 0, 0, 0, time.Local), err: ErrOverFlow, columnDesc: "bigdatetime not null", output: nil},
		{value: nil, err: nil, columnDesc: "bigdatetime null", output: nil},
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "bigdatetime not null", output: nil},

		// bigtime
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "bigtime not null", output: nil},
		{value: nil, err: nil, columnDesc: "bigtime null", output: nil},
		{value: time.Date(1990, time.Month(10), 12, 22, 55, 01, 999999000, time.Local), err: nil, columnDesc: "bigtime not null", output: time.Date(1900, time.Month(1), 1, 22, 55, 01, 999999000, time.Local)},

		// time
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "time not null", output: nil},
		{value: nil, err: nil, columnDesc: "time null", output: nil},
		{value: time.Date(1990, time.Month(10), 12, 22, 55, 01, 0, time.Local), err: nil, columnDesc: "time not null", output: time.Date(1900, time.Month(1), 1, 22, 55, 01, 0, time.Local)},

		// numeric
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "numeric(12,4) not null", output: nil},
		{value: nil, err: nil, columnDesc: "numeric(12,4) null", output: nil},
		{value: num1, err: nil, columnDesc: "numeric(12,4) not null", output: num1},
		{value: num1, err: ErrOverFlow, columnDesc: "numeric(10,4) not null", output: nil},
		{value: int64(144), err: nil, columnDesc: "numeric(12,4) not null", output: num2},
		{value: "-0.01", err: nil, columnDesc: "numeric(14,2) not null", output: num3},

		// real
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "real not null", output: nil},
		{value: nil, err: nil, columnDesc: "real null", output: nil},
		{value: float64(math.MaxFloat64), err: ErrOverFlow, columnDesc: "real not null", output: nil},
		{value: float32(1442.212), err: nil, columnDesc: "real not null", output: float32(1442.212)},
		{value: float32(214748.35), err: nil, columnDesc: "real not null", output: float32(214748.35)},

		// float
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "float not null", output: nil},
		{value: nil, err: nil, columnDesc: "float null", output: nil},
		{value: float64(1442.212), err: nil, columnDesc: "float not null", output: float64(1442.212)},

		// bigint
		{value: int64(3230), err: nil, columnDesc: "bigint not null", output: int64(3230)},
		{value: uint64(math.MaxInt64 + 1), err: ErrOverFlow, columnDesc: "bigint not null", output: nil},
		{value: int64(math.MaxInt64), err: nil, columnDesc: "bigint not null", output: int64(math.MaxInt64)},
		{value: int64(math.MinInt64), err: nil, columnDesc: "bigint not null", output: int64(math.MinInt64)},
		{value: nil, err: nil, columnDesc: "bigint null", output: nil},
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "bigint not null", output: nil},

		// tinyint
		{value: int64(200), err: nil, columnDesc: "tinyint not null", output: int64(200)},
		{value: int64(math.MaxUint8 + 1), err: ErrOverFlow, columnDesc: "tinyint not null", output: nil},
		{value: int64(math.MaxUint8), err: nil, columnDesc: "tinyint not null", output: int64(math.MaxUint8)},
		{value: int64(-1), err: ErrOverFlow, columnDesc: "tinyint not null", output: nil},
		{value: nil, err: nil, columnDesc: "tinyint null", output: nil},
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "tinyint", output: nil},

		// unsigned int
		{value: int64(3230), err: nil, columnDesc: "unsigned int not null", output: int64(3230)},
		{value: math.MaxUint32 + 1, err: ErrOverFlow, columnDesc: "unsigned int not null", output: nil},
		{value: -1, err: ErrOverFlow, columnDesc: "unsigned int not null", output: nil},
		{value: int64(math.MaxUint32), err: nil, columnDesc: "unsigned int not null", output: int64(math.MaxUint32)},
		{value: nil, err: nil, columnDesc: "unsigned int null", output: nil},
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "unsigned int not null", output: nil},

		// unsigned smallint
		{value: int64(3230), err: nil, columnDesc: "unsigned smallint not null", output: int64(3230)},
		{value: math.MaxUint16 + 1, err: ErrOverFlow, columnDesc: "unsigned smallint null", output: nil},
		{value: -1, err: ErrOverFlow, columnDesc: "unsigned smallint null", output: nil},
		{value: int64(math.MaxUint16), err: nil, columnDesc: "unsigned smallint not null", output: int64(math.MaxUint16)},
		{value: nil, err: nil, columnDesc: "unsigned smallint null", output: nil},
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "unsigned smallint not null", output: nil},

		// unsigned bigint
		{value: uint64(3230), err: nil, columnDesc: "unsigned bigint not null", output: uint64(3230)},
		{value: -1, err: ErrOverFlow, columnDesc: "unsigned bigint not null", output: nil},
		{value: uint64(math.MaxUint64), err: nil, columnDesc: "unsigned bigint not null", output: uint64(math.MaxUint64)},
		{value: nil, err: nil, columnDesc: "unsigned bigint null", output: nil},
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "unsigned bigint not null", output: nil},

		// tinyint
		{value: int64(200), err: nil, columnDesc: "unsigned tinyint not null", output: int64(200)},
		{value: int64(math.MaxUint8 + 1), err: ErrOverFlow, columnDesc: "unsigned tinyint not null", output: nil},
		{value: int64(math.MaxUint8), err: nil, columnDesc: "unsigned tinyint not null", output: int64(math.MaxUint8)},
		{value: int64(-1), err: ErrOverFlow, columnDesc: "unsigned tinyint not null", output: nil},
		{value: nil, err: nil, columnDesc: "unsigned tinyint null", output: nil},
		{value: nil, err: errors.New("Msg: 515"), columnDesc: "unsigned tinyint not null", output: nil},

		// money/smallmoney
		{value: getNum("214748.35", 10, 4), err: nil, columnDesc: "smallmoney", output: getNum("214748.35", 10, 4)},
		{value: getNum("922337203685477.56", 19, 4), err: nil, columnDesc: "money", output: getNum("922337203685477.56", 19, 4)},
		{value: getNum("922337203685477.5807", 19, 4), err: nil, columnDesc: "money null", output: getNum("922337203685477.5807", 19, 4)},
		{value: getNum("922337203685477.56", 19, 4), err: nil, columnDesc: "money", output: getNum("922337203685477.56", 19, 4)},
		{value: getNum("-922337203685477.56", 19, 4), err: nil, columnDesc: "money", output: getNum("-922337203685477.56", 19, 4)},
		{value: getNum("214748.35", 10, 4), err: nil, columnDesc: "smallmoney", output: getNum("214748.35", 10, 4)},
		{value: getNum("-214748.35", 10, 4), err: nil, columnDesc: "smallmoney", output: getNum("-214748.35", 10, 4)},
